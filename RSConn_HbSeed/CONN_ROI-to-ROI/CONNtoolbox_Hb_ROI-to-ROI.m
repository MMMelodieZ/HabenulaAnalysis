...
addpath('/nafs/narr/HCP_OUTPUT/Habenula/conn')
addpath('/nafs/apps/spm')

TARGETpath='/nafs/narr/HCP_OUTPUT/Habenula/outputs/RSConn_HbSeed/SubjectsDATA_Denoised';                                                             % target folder for conn project (default current folder)
...
subs=dir(regexprep(CONNECTOMEpath,'%s.*$','k000*'));
...
for n=1:numel(subs)
    ...
    if COPYFILES
        ...
        [ok,nill]=mkdir(fullfile(TARGETpath,'LocalCopyDataFiles'),'k000401');
