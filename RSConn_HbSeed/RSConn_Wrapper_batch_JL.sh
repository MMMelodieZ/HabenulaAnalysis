...
--job-name=c${s} --output=/${maindir}/outputs/RSConn_HbSeed/logs/job_logs/RSConn_wDenoising_${s}.log --export=SUBJ=${s} ${maindir}/code/RSConn_HbSeed/RSConn_Wrapper_JL.sh	
