...
SubList=$(<${maindir}/outputs/RSConn_HbSeed/Sublist_RSConn_crossSectional.txt)
...
--job-name=s${s} --output=${maindir}/outputs/RSConn_HbSeed/logs/job_logs/smooth_RSConn_${s}_${r}.log --export=SUBJ=${s},ROI=${r} ${maindir}/code/RSConn_HbSeed/Smooth_RSConnMaps_JL.sh
