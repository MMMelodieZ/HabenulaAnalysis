...
wb_command -cifti-smoothing ${datadir}/${SUBJ}/MNINonLinear/Results/rest_acq-${PEDIR}_run-01/rest_acq-${PEDIR}_run-01_Atlas_MSMAll_Test_hp2000_clean.dtseries.nii ${smoothingKernel} ${smoothingKernel} COLUMN ${outputdir}/s${smooth}rest_acq-${PEDIR}_run-01_Atlas_MSMAll_Test_hp2000_clean.dtseries.nii -left-surface ${datadir}/${SUBJ}/MNINonLinear/fsaverage_LR32k/${SUBJ}.L.midthickness_MSMAll_Test.32k_fs_LR.surf.gii -right-surface ${datadir}/${SUBJ}/MNINonLinear/fsaverage_LR32k/${SUBJ}.R.midthickness_MSMAll_Test.32k_fs_LR.surf.gii
